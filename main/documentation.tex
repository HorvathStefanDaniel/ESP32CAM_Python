...
\begin{itemize}
    ...
    \item \texttt{face\_recognition} ($\geq$1.3.0) -- optional; uncomment in \texttt{requirements.txt} to enable \texttt{face\_detect.py --recognize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \texttt{run.exe} -- Windows executable (build with \texttt{python build\_run\_exe.py}); double-click for menu or pass script name and args
